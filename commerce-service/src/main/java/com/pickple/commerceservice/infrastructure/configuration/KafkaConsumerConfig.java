...
public class KafkaConsumerConfig {
    ...
    /**
     * DLQ 전용 KafkaTemplate (StringSerializer 사용)
     */
    @Bean
    ...
    /**
     * Dead Letter Queue + 재시도 기반 에러 핸들러
     * - 최대 3회 재시도 (1초 간격)
     * - 재시도 실패 시 원본 토픽명.DLT 토픽으로 메시지 전송
     * - DeserializationException은 재시도 없이 즉시 DLQ로 전송
     */
    @Bean
